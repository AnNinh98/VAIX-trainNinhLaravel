        ...
        <div class="body-section">
            <div class="row">
                <div class="col-6">
                    ...
                    <p class="sub-heading">Tên danh mục: {{$bill->items->item_name}} </p>
                    <p class="sub-heading">Giá danh mục: {{number_format($bill->items->amount,0)}} VNĐ</p>
                    <p class="sub-heading">Ngày tạo hóa đơn: {{$bill->today}} </p>
                    <p class="sub-heading">Thời hạn trả: {{$bill->expire_date}} </p>
                </div>
                <div class="col-6">
                    <p class="sub-heading">Tên công ty: {{$bill->items->project->company->company_name}}</p>
                    <p class="sub-heading">Địa chỉ công ty: {{$bill->items->project->company->company_address}}</p>
                    <p class="sub-heading">Số điện thoại: {{$bill->items->project->company->company_tel}}</p>
                    <p class="sub-heading">Số fax: {{$bill->items->project->company->company_fax}}</p>
